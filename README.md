...
O computador joga da melhor forma possível, então o visitante não consegue vencê-lo: no máximo a partida empata.
...
- Jogadas do computador na melhor forma possível, sem deixar o visitante vencer;
